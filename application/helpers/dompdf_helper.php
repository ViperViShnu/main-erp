    ...
    if ($stream) {
        ...
        if (!empty($attach)) {
            if (!empty($folder_name)) {
                if(!is_dir('uploads/temp/' . $folder_name)) {
                    mkdir('uploads/temp/' . $folder_name, 0777, true);
                }
                $folder = "uploads/temp/" . $folder_name . '/' . $filename . ".pdf";;
            } else {
                $folder = "uploads/temp/" . $filename . ".pdf";;
            }
