                ...
                if ($data['update_stock'] == 'Yes') {
                    if (!empty($items['saved_items_id']) && $items['saved_items_id'] != 'undefined') {
                        if (!empty($items['items_id'])) {
                            ...
                            $this->return_stock_model->reduce_items($items['saved_items_id'], $items['quantity'], $data['warehouse_id']); // 2024-10-23
                        }
                    }
                }
...
The " . config_item('company_name') . " Team </p > ";
    ...
    public function payments_pdf($id)
    {
        ...
        $viewfile = $this->load->view('admin/return_stock/payments_pdfNew', $data, TRUE); // 2024-12-07
