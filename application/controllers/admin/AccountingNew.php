...
class Accounting extends Admin_Controller
{
    ...
    public function save_chart_of_account_old($id = null)
    {
        ...
        if (!empty($created) || !empty($edited) && !empty($id)) {
            ...
            if (!empty($code_exists)) {
                ...
                set_message($type, $message);
                // echo "<pre>"; print_r($type); echo "<br>"; print_r($message); die;
    ...
    public function save_chart_of_account($id = null, $inline = null)
    {
        $created = can_action_by_label('chart_of_accounts', 'created');
        $edited = can_action_by_label('chart_of_accounts', 'edited');
        if (!empty($created) || (!empty($edited) && !empty($id))) {
            ...
            // Handle inline/modal form submission
            if (!empty($inline)) {
                if (!empty($id)) {
                    $result = array(
                        'fieldName' => 'chart_of_account_id',
                        'fieldId' => $id,
