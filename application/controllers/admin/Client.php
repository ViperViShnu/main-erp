...
class Client extends Admin_Controller
{
    ...
    public function getGstDetails() {
        $email = "ashlinadvisories@gmail.com";
        $userName = "mastergst";
        $password = "Malli#123";
        $ipAddress = "0.0.0.0";
        $clientId = "2ade9e93-187f-4883-a7b3-769c316f926a";
        $clientSecret = "219819cc-a91a-485f-8b1b-80803246c392";
        $gstin = "29AABCT1332L000";
        $gstinClient = $this->input->post('gstNumber');

        $url = 'https://api.mastergst.com/einvoice/authenticate?email='.$email;
        ...
        if (curl_errno($ch)) {
            ...
            $url = 'https://api.mastergst.com/einvoice/type/GSTNDETAILS/version/V1_03?param1='.$gstinClient.'&email='.$email;
            ...
            if(curl_errno($ch)) {
                echo json_decode(curl_error($ch)); die;
            } else {
                echo $response; die;
            }
        }
