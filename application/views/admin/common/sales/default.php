...
<div class="panel" id="sales_details">
            ...
            <div class="table-responsive mb-lg">
                <table class="table items invoice-items-preview" page-break-inside: auto;>
                    ...
                    <tr>
                        ...
                        <th class="col-sm-1"><?= lang('unit') . ' ' . lang('price') ?></th>
                        <th class="col-sm-2"><?= lang('sub_total') ?></th>
                        ...
                        foreach ($all_items as $key => $v_item) :
                            ...
                            <tr class="sortable item" data-item-id="<?= $v_item->$itemId ?>">
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td><?= display_money($v_item->total_cost + $v_item->item_tax_total) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
                        <tr>
    ...
    // if (empty($sales_info->item_layout)) {
        ?>
        <?php // echo !empty($invoice_view) && $invoice_view > 0 ? $this->gst->summary($all_items) : ''; ?>
        <?php
    // }
    ?>
</div>
