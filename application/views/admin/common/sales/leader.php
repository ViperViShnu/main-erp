                ...
                <div class="t-border" style="border-radius : 0.25rem;padding:1.5rem">
                    <table class="f-table items align-middle">
                            ...
                            foreach ($all_items as $key => $v_item) :
                                ...
                                <tr data-item-id="<?= $v_item->$itemId ?>">
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td class="text-end"><?= display_money($v_item->total_cost + $v_item->item_tax_total) ?></td>
                                </tr>
                        ...
                        <?php if ($sales_info->discount > 0) : ?>
                            <tr>
                                <th colspan="7" class="border-0 text-end"><?= lang('discount') ?>
                        ...
                        <?php if ($tax_total > 0) : ?>
                            <tr>
                                <th colspan="7" class="border-0 text-end"><?= lang('total') . ' ' . lang('tax') ?></th>
                                <td class="border-0 text-end"><?= display_money($tax_total); ?></td>
                            </tr>
                        <?php endif ?>
                        <?php if ($sales_info->adjustment > 0) : ?>
                            <tr>
                                <th colspan="7" class="border-0 text-end"><?= lang('adjustment') ?></th>
                        ...
                        ?>
                        <tr>
                            <th colspan="7" class="border-0 text-end"><?= lang('total') ?></th>
                        ...
                        if (!empty($paid_amount) && $paid_amount > 0) {
                            ...
                            if ($paid_amount > 0) {
                                ...
                                ?>
                                <tr>
                                    <th colspan="7" class="border-0 text-end"><?= lang('paid_amount') ?></th>
                                    <td class="border-0 text-end">
                        ...
                        if (!empty($paid_amount) && $paid_amount > 0) { ?>
                            ...
                            <tr>
                                <th colspan="7" class="border-0 text-end <?= $text ?>"><?= $total ?></th>
