                        ...
                        <ul class="nav"><?php
                            ...
                            <li class="<?php
                                ...
                                <?php
                                        ...
                                        ?>
                                <a
                                    href="<?= base_url() ?>admin/purchase/payments_details/<?= $v_purchase->purchase_id ?>">
                                    <?= $client_name ?>
                                ...
                                <div style="padding:5px;">
                                    ...
                                    <div style="width: 70%;float: left;">
                                        ...
                                        <div style="width: 100%;padding: 11px 0;">
                                            ...
                                            <div class="payment_details_border_semi">
                                                <?= number_to_word('', $payments_info->amount); ?></div>
                                            <div style="clear:both;"></div>
                                        </div>
                                        <?php } ?>
                                    ...
                                    if ($role == 1 && $payments_info->account_id != 0) {
                                        ...
                                        if (!empty($account_info)) {
                                            ...
                                            <div style="padding-top:25px">
                                                <div class="payment_details_border">
                                                    <a
                                                            href="<?= base_url() ?>admin/account/create_account/<?= $account_info->account_id ?>"><?= $account_info->account_name ?></a>
                                                </div>
                                                <div style="color:#999;width:25%"><?= lang('paid_amount_from ') ?></div>
                                            </div>
                                        <?php }
                                    } ?>
                                    <div style="padding-top:25px">
