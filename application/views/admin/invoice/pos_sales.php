    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.nav-tabs a').on('click', function(e) {
                ...
                $('.tab-pane').removeClass('show active').empty();

                // Show the clicked tab content
                $(targetTab).addClass('show active');

                // Load the items only for the active tab (optional if content is generated dynamically)
                $(targetTab).html($(targetTab).data('content'));
            });
        });
    </script>
