            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a
                     ...
                     <li class="active"><a href="<?= base_url('admin/invoice/invoice_export') ?>">GSTR1</a>
                    </li>
                </ul>
                                        ...
                                        <div class="col-lg-7">
                                            <div class="input-group">
                                                <input type="text" name="start_date" class="form-control datepicker"
                                                       value="<?php echo date('Y-m-d', strtotime('-1 day')); ?>" data-date-format="<?= config_item('date_picker_format'); ?>" required>
