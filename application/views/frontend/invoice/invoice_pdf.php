...
} else if(is_file(config_item('invoice_logo'))) {
    $img = base_url() . config_item('invoice_logo');
} else {
...
<table class="items">
    ...
    <tr>
        ...
        <th style="text-align: right"><?= $language_info['unit'] . ' ' . $language_info['price'] ?></th>
        <th style="text-align: right"><?= $language_info['sub_total'] ?></th>
        ...
        foreach ($invoice_items as $key => $v_item) :
            ...
            <tr>
                ...
                <td class="unit" style="text-align: right"><?php
                    ...
                    ?></td>
                <td class="unit" style="text-align: right"><?= display_money($v_item->total_cost + $v_item->item_tax_total) ?></td>
            </tr>
        <?php endforeach; ?>
    <?php endif ?>
